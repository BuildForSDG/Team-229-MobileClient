      ...
      <KeyboardAvoidingView style={styles.containerView} behavior="padding">
        <View style={styles.loginScreenContainer}>
          <View style={styles.loginFormView}>
            ...
            <TextInput placeholder="Contact" placeholderColor="#c4c3cb" style={styles.loginFormTextInput} />
            ...
            <TextInput placeholder="Re-type Password" placeholderColor="#c4c3cb" style={styles.loginFormTextInput} />
